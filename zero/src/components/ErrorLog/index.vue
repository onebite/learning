            ...
            <el-table :data="errorLogs" border="">
                <el-table-column label="Message">
                    <template slot-scope="scope">
                        <div>
                            <span class="messsage-title">Msg:</span>
                            <el-tag type="danger">{{ scope.row.err.messsage }}</el-tag>
                        </div>
                        <br>
                        <div>
                            <span class="message-title" style="padding-right: 10px;"></span>
                            <el-tag type="warning">{{ scope.row.vm.$vnode.tag }}</el-tag>
                        </div>
                        <br>
                        <div>
                            <span class="message-title" style="padding-right: 16px;"></span>
